...
try:
    ...
    try:
        from transformers.models.qwen2 import (
            Qwen2ForCausalLM as Qwen3ForCausalLM,
            Qwen2ForSequenceClassification as Qwen3ForSequenceClassification,
            Qwen2Model as Qwen3Model,
            Qwen2PreTrainedModel as Qwen3PreTrainedModel,
        )
    except ImportError:
        raise ImportError(
...
class DistributedQwen3Model(FromPretrainedMixin, PTuneMixin, Qwen3Model):
    """Qwen3Model, but all transformer layers are hosted by the swarm"""
