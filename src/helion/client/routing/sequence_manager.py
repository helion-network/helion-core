...
from helion.client.routing.sequence_info import RemoteSequenceInfo
from helion.client.routing.spending_policy import NoSpendingPolicy
from helion.data_structures import ModuleUID, RemoteSpanInfo, ServerState
from helion.server.handler import TransformerConnectionHandler
from helion.utils.dht import get_remote_module_infos
...
class MissingBlocksError(RuntimeError):
    def __init__(self, block_indices: Union[int, Sequence[int]]):
        super().__init__(
            ...
            f"https://github.com/helion-network/helion-core?tab=readme-ov-file#connect-your-gpu-and-increase-helion-capacity"
        )
