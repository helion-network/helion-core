...
from helion.data_structures import CHAIN_DELIMITER, UID_DELIMITER, ModelInfo, ServerInfo, ServerState, parse_uid
from helion.server import block_selection
from helion.server.backend import TransformerBackend, merge_inference_pools_inplace
from helion.server.block_utils import get_block_size, resolve_block_dtype
from helion.server.from_pretrained import load_pretrained_block
from helion.server.handler import TransformerConnectionHandler
from helion.server.memory_cache import MemoryCache
from helion.server.reachability import ReachabilityProtocol, check_direct_reachability, validate_reachability
from helion.server.throughput import get_dtype_name, get_server_throughput
from helion.utils.auto_config import AutoDistributedConfig
from helion.utils.convert_block import QuantType, check_device_balance, convert_block
...
from helion.utils.ping import PingAggregator
from helion.utils.random import sample_up_to
from helion.utils.version import get_compatible_model_repo
...
class Server:
    ...
    def _choose_num_blocks(self) -> int:
        ...
        if self.adapters:
            ...
            from helion.utils.peft import estimate_adapter_memory_per_block
