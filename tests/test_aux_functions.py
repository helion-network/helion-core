...
from helion.server.throughput import measure_compute_rps
from helion.utils.convert_block import QuantType
from helion.utils.misc import DUMMY, is_dummy
from helion.utils.packaging import pack_args_kwargs, unpack_args_kwargs
...
def test_bnb_not_imported_when_unnecessary():
    ...
    If this test fails, please change your code to import bitsandbytes and/or helion.utils.peft
    ...
    subprocess.check_call([sys.executable, "-c", "import helion, sys; assert 'bitsandbytes' not in sys.modules"])
